...
public class DeliveryPartner extends Fragment {
    ...
    private static final String url="http://bazaarse.epizy.com/delivery";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_delivery_partner, container, false);
        context=getContext();
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isNetworkStatusAvialable(requireNonNull(getContext()))) {
                    Toast.makeText(getContext(), "Internet available", Toast.LENGTH_SHORT).show();


                    assert getFragmentManager() != null;
                    FragmentTransaction ft = getFragmentManager().beginTransaction();
                    ft.detach(DeliveryPartner.this).attach(DeliveryPartner.this).commit();
        ...
        if (DetectConnection.checkInternetConnection(requireNonNull(getContext()))) {
    ...
    private class CustomWebViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("http://bazaarse.epizy.com/delivery")) {
                view.loadUrl(url);
