 ...
 */
public class Distrubter extends Fragment {
   private  WebView webview;
    ...
    private  static final String url="http://bazaarse.epizy.com/distributor";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_distrubter, container, false);
        context=getContext();
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isNetworkStatusAvialable(Objects.requireNonNull(getContext()))) {
                    ...
                    ft.detach(Distrubter.this).attach(Distrubter.this).commit();
    ...
    private class CustomWebViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("http://bazaarse.epizy.com/distributor")) {
                view.loadUrl(url);
